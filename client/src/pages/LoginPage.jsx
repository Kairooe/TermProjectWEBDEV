  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        ...
        <div style={s.btn} onClick={!loading ? handleLogin : undefined}>
...
const s = {
  ...
  input: { width: '100%', padding: '10px 12px', borderRadius: 8, border: '1.5px solid #ddd', fontSize: 15, outline: 'none', boxSizing: 'border-box', transition: 'border-color 0.2s' },
